...
void RGraphicsPipeline::create(const std::string &vertexShaderFile,
    ...
    auto vertexShader = RCreator::create<RShaderModule>(logicalDevice, vertexShaderFile);
    auto fragmentShader = RCreator::create<RShaderModule>(logicalDevice, fragmentShaderFile);
    ...
    if (vkCreatePipelineLayout(logicalDevice->handle(), &pipelineLayoutInfo, nullptr, &mPipelineLayout) != VK_SUCCESS) {
